...
import { defaultConfig as builtinConfig } from './data/config';
...
// ===== 默认数据（从 src/data/ 读取，发布时更新这两个文件即可）=====
const defaultPosts: Post[] = builtinPosts as unknown as Post[];
const defaultConfig: SiteConfig = builtinConfig as unknown as SiteConfig;
...
// knownSha: 如果调用方已知当前 SHA，可直接传入，跳过 GET 请求
